...
function app(){
    ...
    loader.load(
                ...
                new Parse.Query(Parse.FurnitureItem)
                    ...
                    .find().then(function(results) {
                        ...
                        $('.thirdPartyVendors').each(function(){
                            if (newItem.thirdPartyVendors.indexOf(this.value)>-1)
                                this.checked = true
                        })
                        window.location.hash = 'mod-item';
                    });
        ...
        ////////////////////////
        //
        // $('.generate-MR').on('click' , function(e) {
        //     e.preventDefault()
        ...
        $('input[type=file]').on('change' , function(e){
            ...
            if (fileUploadControl.files.length > 0) {
                ...
                if (newItem.imageCount==undefined)
                    ...
                    newItem.imageCount++
                var name = 'fullPhoto'+newItem.imageCount;
        ...
        $('.add-item-category').on('click' , function(){
